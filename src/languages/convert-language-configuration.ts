...
/**
 * Format of language configuration JSON files used by VSCode extensions
 */
...
/**
 * Converts a VSCode language configuration JSON to a monaco-compatible language configuration object.
 */
