...
const jsonDiagnosticDefault: Required<DiagnosticsOptions> = {
  validate: true,
  allowComments: false,
  schemas: [],
...
const jsoncDiagnosticDefault: Required<DiagnosticsOptions> = {
  validate: true,
  allowComments: true,
  schemas: [],
  enableSchemaRequest: true,
...
export const jsonDefaults: LanguageServiceDefaults = new LanguageServiceDefaultsImpl(
  'json',
  jsonDiagnosticDefault,
  modeConfigurationDefault
);

export const jsoncDefaults: LanguageServiceDefaults = new LanguageServiceDefaultsImpl(
  'jsonc',
  jsoncDiagnosticDefault,
  modeConfigurationDefault
);
...
languages.onLanguage('jsonc', () => {
  getMode().then((mode) => mode.setupMode(jsoncDefaults));
});
