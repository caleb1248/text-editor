...
var webWorkerOrigin = isWebWorker ? $globalThis.origin : undefined;
...
var codiconsLibrary = {
  ...
  gistNew: register("gist-new", 60000),
  repoCreate: register("repo-create", 60000),
...
var symbolKindNames = {
  [17]: localize(757, "array"),
  [16]: localize(758, "boolean"),
  [4]: localize(759, "class"),
  [13]: localize(760, "constant"),
  [8]: localize(761, "constructor"),
  [9]: localize(762, "enumeration"),
  [21]: localize(763, "enumeration member"),
  [23]: localize(764, "event"),
  [7]: localize(765, "field"),
  [0]: localize(766, "file"),
  [11]: localize(767, "function"),
  [10]: localize(768, "interface"),
  [19]: localize(769, "key"),
  [5]: localize(770, "method"),
  [1]: localize(771, "module"),
  [2]: localize(772, "namespace"),
  [20]: localize(773, "null"),
  [15]: localize(774, "number"),
  [18]: localize(775, "object"),
  [24]: localize(776, "operator"),
  [3]: localize(777, "package"),
  [6]: localize(778, "property"),
  [14]: localize(779, "string"),
  [22]: localize(780, "struct"),
  [25]: localize(781, "type parameter"),
  [12]: localize(782, "variable")
};
var SymbolKinds;
...
class TextReplacement {
  ...
  removeCommonPrefix(text) {
    const normalizedOriginalText = text.getValueOfRange(this.range).replaceAll(`\r
`, `
`);
    const normalizedModifiedText = this.text.replaceAll(`\r
`, `
`);
...
(function(Diagnostic2) {
  ...
  function is(value) {
    var _a2;
    let candidate = value;
    return Is.defined(candidate) && Range2.is(candidate.range) && Is.string(candidate.message) && (Is.number(candidate.severity) || Is.undefined(candidate.severity)) && (Is.integer(candidate.code) || Is.string(candidate.code) || Is.undefined(candidate.code)) && (Is.undefined(candidate.codeDescription) || Is.string((_a2 = candidate.codeDescription) === null || _a2 === undefined ? undefined : _a2.href)) && (Is.string(candidate.source) || Is.undefined(candidate.source)) && (Is.undefined(candidate.relatedInformation) || Is.typedArray(candidate.relatedInformation, DiagnosticRelatedInformation.is));
  }
  Diagnostic2.is = is;
...
(function(Hover2) {
  function is(value) {
    let candidate = value;
    return !!candidate && Is.objectLiteral(candidate) && (MarkupContent.is(candidate.contents) || MarkedString.is(candidate.contents) || Is.typedArray(candidate.contents, MarkedString.is)) && (value.range === undefined || Range2.is(value.range));
  }
  Hover2.is = is;
})(Hover || (Hover = {}));
...
(function(DocumentSymbol2) {
  ...
  function is(value) {
    let candidate = value;
    return candidate && Is.string(candidate.name) && Is.number(candidate.kind) && Range2.is(candidate.range) && Range2.is(candidate.selectionRange) && (candidate.detail === undefined || Is.string(candidate.detail)) && (candidate.deprecated === undefined || Is.boolean(candidate.deprecated)) && (candidate.children === undefined || Array.isArray(candidate.children)) && (candidate.tags === undefined || Array.isArray(candidate.tags));
  }
...
(function(CodeAction2) {
  ...
  function is(value) {
    let candidate = value;
    return candidate && Is.string(candidate.title) && (candidate.diagnostics === undefined || Is.typedArray(candidate.diagnostics, Diagnostic.is)) && (candidate.kind === undefined || Is.string(candidate.kind)) && (candidate.edit !== undefined || candidate.command !== undefined) && (candidate.command === undefined || Command2.is(candidate.command)) && (candidate.isPreferred === undefined || Is.boolean(candidate.isPreferred)) && (candidate.edit === undefined || WorkspaceEdit.is(candidate.edit));
  }
  CodeAction2.is = is;
...
(function(SelectionRange2) {
  ...
  function is(value) {
    let candidate = value;
    return Is.objectLiteral(candidate) && Range2.is(candidate.range) && (candidate.parent === undefined || SelectionRange2.is(candidate.parent));
  }
...
(function(InlineValueText2) {
  ...
  function is(value) {
    const candidate = value;
    return candidate !== undefined && candidate !== null && Range2.is(candidate.range) && Is.string(candidate.text);
  }
...
(function(InlineValueVariableLookup2) {
  ...
  function is(value) {
    const candidate = value;
    return candidate !== undefined && candidate !== null && Range2.is(candidate.range) && Is.boolean(candidate.caseSensitiveLookup) && (Is.string(candidate.variableName) || candidate.variableName === undefined);
  }
...
(function(InlineValueEvaluatableExpression2) {
  ...
  function is(value) {
    const candidate = value;
    return candidate !== undefined && candidate !== null && Range2.is(candidate.range) && (Is.string(candidate.expression) || candidate.expression === undefined);
  }
...
(function(InlayHintLabelPart2) {
  ...
  function is(value) {
    const candidate = value;
    return Is.objectLiteral(candidate) && (candidate.tooltip === undefined || Is.string(candidate.tooltip) || MarkupContent.is(candidate.tooltip)) && (candidate.location === undefined || Location.is(candidate.location)) && (candidate.command === undefined || Command2.is(candidate.command));
  }
...
(function(InlayHint2) {
  ...
  function is(value) {
    const candidate = value;
    return Is.objectLiteral(candidate) && Position2.is(candidate.position) && (Is.string(candidate.label) || Is.typedArray(candidate.label, InlayHintLabelPart.is)) && (candidate.kind === undefined || InlayHintKind3.is(candidate.kind)) && candidate.textEdits === undefined || Is.typedArray(candidate.textEdits, TextEdit.is) && (candidate.tooltip === undefined || Is.string(candidate.tooltip) || MarkupContent.is(candidate.tooltip)) && (candidate.paddingLeft === undefined || Is.boolean(candidate.paddingLeft)) && (candidate.paddingRight === undefined || Is.boolean(candidate.paddingRight));
  }
  InlayHint2.is = is;
})(InlayHint || (InlayHint = {}));
var StringValue;
...
function validate(n, schema, validationResult, matchingSchemas, context) {
  ...
  function _validateArrayNode(node2) {
    ...
    if (additionalItemSchema !== undefined && index < node2.items.length) {
...
function parse3(textDocument, config) {
  ...
  function _parseArray(parent) {
    ...
    while (scanner.getToken() !== 4 && scanner.getToken() !== 17) {
      ...
      if (!item) {
        _error(t("Value expected"), ErrorCode.ValueExpected, undefined, [], [4, 5]);
      } else {
  ...
  function _parseObject(parent) {
    ...
    while (scanner.getToken() !== 2 && scanner.getToken() !== 17) {
      ...
      if (!property) {
        _error(t("Property expected"), ErrorCode.PropertyExpected, undefined, [], [2, 5]);
      } else {
...
(() => {
  var t2 = { 975: (t3) => {
          ...
          if (o2 === h2 - 1 || s2 === 1)
            ...
            if (n3.length < 2 || i2 !== 2 || n3.charCodeAt(n3.length - 1) !== 46 || n3.charCodeAt(n3.length - 2) !== 46) {
              if (n3.length > 2) {
                ...
                if (a3 !== n3.length - 1) {
                  a3 === -1 ? (n3 = "", i2 = 0) : i2 = (n3 = n3.slice(0, a3)).length - 1 - n3.lastIndexOf("/"), o2 = h2, s2 = 0;
                  continue;
                }
    ...
    var n2 = { resolve: function() {
      for (var t4, n3 = "", i2 = false, o2 = arguments.length - 1;o2 >= -1 && !i2; o2--) {
        var s2;
        o2 >= 0 ? s2 = arguments[o2] : (t4 === undefined && (t4 = process.cwd()), s2 = t4), e2(s2), s2.length !== 0 && (n3 = s2 + "/" + n3, i2 = s2.charCodeAt(0) === 47);
      }
      return n3 = r2(n3, !i2), i2 ? n3.length > 0 ? "/" + n3 : "/" : n3.length > 0 ? n3 : ".";
    }, normalize: function(t4) {
      if (e2(t4), t4.length === 0)
        return ".";
      var n3 = t4.charCodeAt(0) === 47, i2 = t4.charCodeAt(t4.length - 1) === 47;
      return (t4 = r2(t4, !n3)).length !== 0 || n3 || (t4 = "."), t4.length > 0 && i2 && (t4 += "/"), n3 ? "/" + t4 : t4;
    }, isAbsolute: function(t4) {
      return e2(t4), t4.length > 0 && t4.charCodeAt(0) === 47;
    }, join: function() {
      if (arguments.length === 0)
        return ".";
      for (var t4, r3 = 0;r3 < arguments.length; ++r3) {
        var i2 = arguments[r3];
        e2(i2), i2.length > 0 && (t4 === undefined ? t4 = i2 : t4 += "/" + i2);
      }
      return t4 === undefined ? "." : n2.normalize(t4);
    }, relative: function(t4, r3) {
      if (e2(t4), e2(r3), t4 === r3)
        return "";
      if ((t4 = n2.resolve(t4)) === (r3 = n2.resolve(r3)))
        return "";
      for (var i2 = 1;i2 < t4.length && t4.charCodeAt(i2) === 47; ++i2)
        ;
      for (var o2 = t4.length, s2 = o2 - i2, h2 = 1;h2 < r3.length && r3.charCodeAt(h2) === 47; ++h2)
        ;
      for (var a3 = r3.length - h2, c2 = s2 < a3 ? s2 : a3, f3 = -1, u2 = 0;u2 <= c2; ++u2) {
        if (u2 === c2) {
          if (a3 > c2) {
            if (r3.charCodeAt(h2 + u2) === 47)
              return r3.slice(h2 + u2 + 1);
            if (u2 === 0)
              return r3.slice(h2 + u2);
          } else
            s2 > c2 && (t4.charCodeAt(i2 + u2) === 47 ? f3 = u2 : u2 === 0 && (f3 = 0));
          break;
        }
      ...
      for (u2 = i2 + f3 + 1;u2 <= o2; ++u2)
        u2 !== o2 && t4.charCodeAt(u2) !== 47 || (g2.length === 0 ? g2 += ".." : g2 += "/..");
      return g2.length > 0 ? g2 + r3.slice(h2 + f3) : (h2 += f3, r3.charCodeAt(h2) === 47 && ++h2, r3.slice(h2));
    }, _makeLong: function(t4) {
      return t4;
    }, dirname: function(t4) {
      if (e2(t4), t4.length === 0)
        return ".";
      for (var r3 = t4.charCodeAt(0), n3 = r3 === 47, i2 = -1, o2 = true, s2 = t4.length - 1;s2 >= 1; --s2)
        if ((r3 = t4.charCodeAt(s2)) === 47) {
          if (!o2) {
            i2 = s2;
            break;
          }
      ...
      if (r3 !== undefined && r3.length > 0 && r3.length <= t4.length) {
        ...
        for (n3 = t4.length - 1;n3 >= 0; --n3) {
          ...
          if (c2 === 47) {
            ...
            a3 === -1 && (s2 = false, a3 = n3 + 1), h2 >= 0 && (c2 === r3.charCodeAt(h2) ? --h2 == -1 && (o2 = n3) : (h2 = -1, o2 = a3));
        }
        return i2 === o2 ? o2 = a3 : o2 === -1 && (o2 = t4.length), t4.slice(i2, o2);
      }
      for (n3 = t4.length - 1;n3 >= 0; --n3)
        if (t4.charCodeAt(n3) === 47) {
          if (!s2) {
            i2 = n3 + 1;
            break;
          }
        } else
          o2 === -1 && (s2 = false, o2 = n3 + 1);
      return o2 === -1 ? "" : t4.slice(i2, o2);
    }, extname: function(t4) {
      e2(t4);
      for (var r3 = -1, n3 = 0, i2 = -1, o2 = true, s2 = 0, h2 = t4.length - 1;h2 >= 0; --h2) {
        var a3 = t4.charCodeAt(h2);
        if (a3 !== 47)
          i2 === -1 && (o2 = false, i2 = h2 + 1), a3 === 46 ? r3 === -1 ? r3 = h2 : s2 !== 1 && (s2 = 1) : r3 !== -1 && (s2 = -1);
        else if (!o2) {
          n3 = h2 + 1;
          break;
        }
      }
      return r3 === -1 || i2 === -1 || s2 === 0 || s2 === 1 && r3 === i2 - 1 && r3 === n3 + 1 ? "" : t4.slice(r3, i2);
    }, format: function(t4) {
      ...
      if (t4.length === 0)
        return r3;
      var n3, i2 = t4.charCodeAt(0), o2 = i2 === 47;
      o2 ? (r3.root = "/", n3 = 1) : n3 = 0;
      for (var s2 = -1, h2 = 0, a3 = -1, c2 = true, f3 = t4.length - 1, u2 = 0;f3 >= n3; --f3)
        if ((i2 = t4.charCodeAt(f3)) !== 47)
          a3 === -1 && (c2 = false, a3 = f3 + 1), i2 === 46 ? s2 === -1 ? s2 = f3 : u2 !== 1 && (u2 = 1) : s2 !== -1 && (u2 = -1);
        else if (!c2) {
          h2 = f3 + 1;
          break;
        }
      return s2 === -1 || a3 === -1 || u2 === 0 || u2 === 1 && s2 === a3 - 1 && s2 === h2 + 1 ? a3 !== -1 && (r3.base = r3.name = h2 === 0 && o2 ? t4.slice(1, a3) : t4.slice(h2, a3)) : (h2 === 0 && o2 ? (r3.name = t4.slice(1, s2), r3.base = t4.slice(1, a3)) : (r3.name = t4.slice(h2, s2), r3.base = t4.slice(h2, a3)), r3.ext = t4.slice(s2, a3)), h2 > 0 ? r3.dir = t4.slice(0, h2 - 1) : o2 && (r3.dir = "/"), r3;
  ...
  class l {
    static isUri(t3) {
      return t3 instanceof l || !!t3 && typeof t3.authority == "string" && typeof t3.fragment == "string" && typeof t3.path == "string" && typeof t3.query == "string" && typeof t3.scheme == "string" && typeof t3.fsPath == "string" && typeof t3.with == "function" && typeof t3.toString == "function";
    }
    scheme;
    authority;
    path;
    ...
    constructor(t3, e2, r2, n2, i2, o2 = false) {
      typeof t3 == "object" ? (this.scheme = t3.scheme || c, this.authority = t3.authority || c, this.path = t3.path || c, this.query = t3.query || c, this.fragment = t3.fragment || c) : (this.scheme = function(t4, e3) {
    ...
    static file(t3) {
      ...
      if (i && (t3 = t3.replace(/\\/g, f2)), t3[0] === f2 && t3[1] === f2) {
        ...
        r2 === -1 ? (e2 = t3.substring(2), t3 = f2) : (e2 = t3.substring(2, r2), t3 = t3.substring(r2) || f2);
      }
  ...
  function m(t3, e2, r2) {
    ...
    for (let o2 = 0;o2 < t3.length; o2++) {
      ...
      if (s2 >= 97 && s2 <= 122 || s2 >= 65 && s2 <= 90 || s2 >= 48 && s2 <= 57 || s2 === 45 || s2 === 46 || s2 === 95 || s2 === 126 || e2 && s2 === 47 || r2 && s2 === 91 || r2 && s2 === 93 || r2 && s2 === 58)
        i2 !== -1 && (n2 += encodeURIComponent(t3.substring(i2, o2)), i2 = -1), n2 !== undefined && (n2 += t3.charAt(o2));
      else {
        n2 === undefined && (n2 = t3.substr(0, o2));
        const e3 = p[s2];
        e3 !== undefined ? (i2 !== -1 && (n2 += encodeURIComponent(t3.substring(i2, o2)), i2 = -1), n2 += e3) : i2 === -1 && (i2 = o2);
      }
    }
  ...
  function y(t3) {
    ...
    for (let r2 = 0;r2 < t3.length; r2++) {
      ...
      n2 === 35 || n2 === 63 ? (e2 === undefined && (e2 = t3.substr(0, r2)), e2 += p[n2]) : e2 !== undefined && (e2 += t3[r2]);
    }
    return e2 !== undefined ? e2 : t3;
  }
  function v(t3, e2) {
    let r2;
    return r2 = t3.authority && t3.path.length > 1 && t3.scheme === "file" ? `//${t3.authority}${t3.path}` : t3.path.charCodeAt(0) === 47 && (t3.path.charCodeAt(1) >= 65 && t3.path.charCodeAt(1) <= 90 || t3.path.charCodeAt(1) >= 97 && t3.path.charCodeAt(1) <= 122) && t3.path.charCodeAt(2) === 58 ? e2 ? t3.path.substr(1) : t3.path[1].toLowerCase() + t3.path.substr(2) : t3.path, i && (r2 = r2.replace(/\//g, "\\")), r2;
  }
  function b(t3, e2) {
    const r2 = e2 ? y : m;
    let n2 = "", { scheme: i2, authority: o2, path: s2, query: h2, fragment: a3 } = t3;
    if (i2 && (n2 += i2, n2 += ":"), (o2 || i2 === "file") && (n2 += f2, n2 += f2), o2) {
      let t4 = o2.indexOf("@");
      if (t4 !== -1) {
        const e3 = o2.substr(0, t4);
        o2 = o2.substr(t4 + 1), t4 = e3.lastIndexOf(":"), t4 === -1 ? n2 += r2(e3, false, false) : (n2 += r2(e3.substr(0, t4), false, false), n2 += ":", n2 += r2(e3.substr(t4 + 1), false, true)), n2 += "@";
      }
  ...
  (function(t3) {
    t3.joinPath = function(t4, ...e2) {
      ...
      if (t4.path.length === 0 || t4.path === _)
        return t4;
      let e2 = P.dirname(t4.path);
      return e2.length === 1 && e2.charCodeAt(0) === 46 && (e2 = ""), t4.with({ path: e2 });
    ...
    switch (c) {
      ...
      case "*":
        ...
        if (!globstar) {
          ...
          const isGlobstar = starCount > 1 && (prevChar === "/" || prevChar === undefined || prevChar === "{" || prevChar === ",") && (nextChar === "/" || nextChar === undefined || nextChar === "," || nextChar === "}");
          if (isGlobstar) {
            if (nextChar === "/") {
              i++;
...
function sort(documentToSort, formattingOptions) {
  ...
  const formattedJsonString = TextDocument2.applyEdits(documentToSort, format4(documentToSort, options, undefined));
  ...
  const edits = format4(sortedJsonDocument, options, undefined);
...
function findJsoncPropertyTree(formattedDocument) {
  ...
  while ((token = scanner.scan()) !== 17) {
    ...
    switch (token) {
      case 10: {
        if (lastNonTriviaNonCommentToken === undefined || lastNonTriviaNonCommentToken === 1 || lastNonTriviaNonCommentToken === 5 && currentContainerStack[currentContainerStack.length - 1] === Container.Object) {
      ...
      case 5: {
        endLineNumber = scanner.getTokenStartLine();
        if (currentProperty.endLineNumber === undefined && (currentContainerStack[currentContainerStack.length - 1] === Container.Object || currentContainerStack[currentContainerStack.length - 1] === Container.Array && (lastNonTriviaNonCommentToken === 2 || lastNonTriviaNonCommentToken === 4))) {
